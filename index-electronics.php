...
<body>
        ...
        <div class="header-top-wrapper-2 border-bottom-2">
            <div class="header-info-wrapper pl-200 pr-200">
                ...
                <div class="electronics-login-register">
                    <ul>
                        <li><a href="cart.php"><i class="pe-7s-users"></i>My Account</a></li>
        ...
        <div >
            <div  id="electro1">
                <div class="custom-row-2">
                    ...
                    //$projects = array();
                    $records = mysqli_query($link,'select name,description,price from products') or die("Query fail: " . mysqli_error());
                    ...
                    <div class="custom-col-style-2 custom-col-4">
                        <div class="product-wrapper product-border mb-24">
                            <div class="product-img-3">
                                ...
                                <img src="assets/img/product/electro/<?php echo ++$i; ?>.jpg" alt="No Image Available">
                                </a>
                                <div class="product-action-right">

                                    <a class="animate-top" title="Add To Cart" href="hanu.php?name=<?php echo $project['name']; ?>&price=<?php echo $project['price'];?>">
                            ...
                            <div class="product-content-4 text-center">
                                ...
                                <h4><a href="product-details.html"><?php echo $project['name']; ?></a></h4>
                                <span><?php echo $project['description']; ?></span>
                                <h5>$ <?php echo $project['price']; ?></h5>
                            </div>
                        </div>
                    </div>
                    <!-- //////////////////// -->
    ...
    <div class="banner-area wrapper-padding pt-30 pb-95">
        <div class="container-fluid">
            <div class="electro-fexible-banner bg-img" style="background-image: url(images/11.gif)">
                <div class="fexible-content">
                    <h3 style="color: white">Play with flexible</h3>
                    <p style="color: white"><b>Multicontrol Smooth Controller, Black Color All Buttons
                        <br>are smooth, Super Shine.</b></p>
